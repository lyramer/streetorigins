This is a project which attempts to source every known origin for a street name within the municipalities of Victoria, Esquimalt, and Oak Bay. The street polylines were obtained through [Overpass queries](https://overpass-turbo.eu). You can find out more about how I processed this data in [my repo which dealt with the backend](https://www.github.com/lyramer/streets).

The actual data on the origins of street names was hand collected by Parker and a team of helpers - thanks to Laurie, Dominic, Josh, Sean, and Will who all gave a hand.

This project was imagined by Parker Andrew, and brought into reality by Andy Wynden. Many thanks to Parker for his enthusiasm, excellent sense of design, and openness to suggestions, which made him a pleasure to work with.
...
- [Overview](#overview)
- [Notes from Create-React-App](#notes-from-create-react-app)

## Overview

This project was built using [Create-React-App](https://github.com/facebookincubator/create-react-app) as a backbone, with [React-Leaflet](https://react-leaflet.js.org/) and [OpenStreetMap](https://www.openstreetmap.org/) who did the heavy lifting in regards to the maps. [Reactstrap](https://reactstrap.github.io/) did some of the nice css work in regards to headers and modals. The [React-Google-Charts](https://react-google-charts.com/) plugin was a wonderfully simple way to get our analytics looking pretty.

The analysis was all run by hand on the back end; as this project scales it would be prudent to connect it to a real database to save us from being buried under a mountain of json files; as it stands, the small heap of json files that currently represents our data structure was by far the most efficient route to get this project off the ground. The [streets repo](https://www.github.com/lyramer/streets) deals with the backend which was used to process the OSM data, integrate the origins data, and finally generate the json files.
